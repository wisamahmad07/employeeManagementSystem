...
<body class="hold-transition login-page">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input name="type" type="text" class="form-control" value="admin" hidden
                            placeholder="type" hidden required>
    ...
    <div>
        <div class="text-end">
            <h3><a class="btn btn-dark mt-2" href="{{ url('employee/loginEmployee') }}">Employee login?</a></h3>
        </div>
        <!-- jQuery -->
